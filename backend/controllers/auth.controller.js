          ...
          <![endif]-->
            ...
            <![endif]-->
              ...
              <tr>
                ...
                <tbody><tr>
                  <td style="background-color:#bed7f6; padding:30px 50px 30px 50px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="#bed7f6"><div><div style="font-family: inherit; text-align: left"><span style="font-size: 18px">Please use the following link to reset your password<br>
          </span><span style="font-size: 10px; color: #123bd2">${process.env.CLIENT_URL}/users/password/reset/${token}</span><span style="color: #123bd2"><br>
          </span><span style="font-size: 18px">This email may contain sensitive information<br>
          </span><span style="font-size: 12px; color: #123bd2">${process.env.CLIENT_URL}</span></div><div></div></div></td>
                </tr>
              </tbody></table><table class="wrapper" role="module" data-type="image" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="6jxKSRk9dKQ1Tvi1wtnu8q">
