...
const EditActivity = ({ history }) => {
  ...
  const loadActivity = () => {
    ...
    axios
      .get(`${process.env.REACT_APP_API_URL}/activity/_id`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      })
      .then(res => {
        const { activityName, description, startDate, bidEndDate, location, responsiblePerson, phoneNo, limitParticipant} = res.data;
  ...
  const handleSubmit = e => {
    ...
    axios
      ...
      .then(res => {
        updateUser(res, () => {
          toast.success('Activity Edit Successfully');
